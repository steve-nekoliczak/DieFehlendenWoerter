...
- The natural language processing (NLP) library (`nlp_json`) sometimes includes open quote characters and the first word as the first indexed entity. The NLP library should separate the two consistently (i.e. `„Der Hund ist klein.“` should give `sentence[0] = '„'`, `sentence[1] = 'Der'`, rather than sometimes giving `sentence[0] = '„Der'`.
### Other
- Write documentation.
